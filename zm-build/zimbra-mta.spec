...
%files
%attr(440, root, root) /etc/sudoers.d/02_zimbra-mta
%attr(-, zimbra, zimbra) /opt/zimbra/common/conf/master.cf.in
%attr(-, zimbra, zimbra) /opt/zimbra/common/conf/tag_as_foreign.re.in
%attr(-, zimbra, zimbra) /opt/zimbra/common/conf/tag_as_originating.re.in
%attr(-, zimbra, zimbra) /opt/zimbra/data/amavisd
%attr(-, zimbra, zimbra) /opt/zimbra/data/clamav
%attr(-, zimbra, zimbra) /opt/zimbra/data/cbpolicyd
%attr(-, zimbra, zimbra) /opt/zimbra/data/opendkim
